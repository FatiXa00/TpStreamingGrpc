...
public final class SalutationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stub.TpStream.SalutRequest,
      stub.TpStream.SalutResponse> getMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "message",
      requestType = stub.TpStream.SalutRequest.class,
      responseType = stub.TpStream.SalutResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<stub.TpStream.SalutRequest,
      stub.TpStream.SalutResponse> getMessageMethod() {
    io.grpc.MethodDescriptor<stub.TpStream.SalutRequest, stub.TpStream.SalutResponse> getMessageMethod;
      ...
      synchronized (SalutationGrpc.class) {
        if ((getMessageMethod = SalutationGrpc.getMessageMethod) == null) {
          SalutationGrpc.getMessageMethod = getMessageMethod = 
              io.grpc.MethodDescriptor.<stub.TpStream.SalutRequest, stub.TpStream.SalutResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Salutation", "message"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.TpStream.SalutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.TpStream.SalutResponse.getDefaultInstance()))
  ...
  public static abstract class SalutationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<stub.TpStream.SalutRequest> message(
        io.grpc.stub.StreamObserver<stub.TpStream.SalutResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                stub.TpStream.SalutRequest,
                stub.TpStream.SalutResponse>(
