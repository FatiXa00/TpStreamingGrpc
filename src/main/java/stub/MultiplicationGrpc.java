...
@javax.annotation.Generated(
    ...
    comments = "Source: TpStream.proto")
public final class MultiplicationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stub.TpStream.MultiplicationRequest,
      stub.TpStream.MultiplicationResponse> getGetMultiplicationTableMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMultiplicationTable",
      requestType = stub.TpStream.MultiplicationRequest.class,
      responseType = stub.TpStream.MultiplicationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<stub.TpStream.MultiplicationRequest,
      stub.TpStream.MultiplicationResponse> getGetMultiplicationTableMethod() {
    io.grpc.MethodDescriptor<stub.TpStream.MultiplicationRequest, stub.TpStream.MultiplicationResponse> getGetMultiplicationTableMethod;
      ...
      synchronized (MultiplicationGrpc.class) {
        if ((getGetMultiplicationTableMethod = MultiplicationGrpc.getGetMultiplicationTableMethod) == null) {
          MultiplicationGrpc.getGetMultiplicationTableMethod = getGetMultiplicationTableMethod = 
              io.grpc.MethodDescriptor.<stub.TpStream.MultiplicationRequest, stub.TpStream.MultiplicationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Multiplication", "GetMultiplicationTable"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.TpStream.MultiplicationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.TpStream.MultiplicationResponse.getDefaultInstance()))
  ...
  public static abstract class MultiplicationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMultiplicationTable(stub.TpStream.MultiplicationRequest request,
        io.grpc.stub.StreamObserver<stub.TpStream.MultiplicationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                stub.TpStream.MultiplicationRequest,
                stub.TpStream.MultiplicationResponse>(
  ...
  public static final class MultiplicationBlockingStub extends io.grpc.stub.AbstractStub<MultiplicationBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<stub.TpStream.MultiplicationResponse> getMultiplicationTable(
        stub.TpStream.MultiplicationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MULTIPLICATION_TABLE:
          serviceImpl.getMultiplicationTable((stub.TpStream.MultiplicationRequest) request,
              (io.grpc.stub.StreamObserver<stub.TpStream.MultiplicationResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MultiplicationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return stub.TpStream.getDescriptor();
    }
